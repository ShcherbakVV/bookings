# анализ данных с сайта booking


В проекте я решаю несколько простых задач бизнеса с помощью библиотеки Pandas, в том числе считаю некоторые метрики, напрмер: churn rate.
___
Здачи проекта:
